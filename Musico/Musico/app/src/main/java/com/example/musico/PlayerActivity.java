...
public class PlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mySongs = (ArrayList<SongModel>)getIntent().getSerializableExtra("songs");
        ...
        updateseekbar.start();
        seekmusic.getProgressDrawable().setColorFilter(getResources().getColor(R.color.av_orange), PorterDuff.Mode.MULTIPLY);
